...
function createSettingsContext() {
  ...
  ['settings-overlay', 'settings-panel', 'settings-open', 'settings-close', 'settings-reset'].forEach((id) => elements.set(id, createElement(id)));
  ...
  return { context, elements, keydown };
}
