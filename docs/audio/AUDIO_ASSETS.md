...
| `BATTLE_DEFEATED` | SFX | 5 variants under `Defeated/` | Creature defeat |
| `BATTLE_PLAYER_DAMAGE` | SFX | 3 variants under `Battle/` | Player hit feedback |
| `BATTLE_ESCAPE_SUCCESS`, `BATTLE_ESCAPE_FAIL` | SFX | matching files under `Battle/` | Escape result feedback |
...
| `BGM_*`, `BATTLE_ENEMY_ATTACK` | Music/SFX | None | Intentional empty mappings |
...
| P0 | Player damage | `BATTLE_PLAYER_DAMAGE` | Yes | Three brief low-impact hurt variants. |
| P1 | Escape result | `BATTLE_ESCAPE_SUCCESS`, `BATTLE_ESCAPE_FAIL` | Yes | Two short contrasting success/failure cues. |
